...
user_data1 = Variable.get("user_data", deserialize_json=True)
transaction_ids1 = Variable.get("transaction_ids", deserialize_json=True)
...
def _producer_explicit_push(**kwargs):
   ...
   transaction_ids =transaction_ids1
